                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6">
                                <div className="project-detail">
                                    <p style={{fontWeight:600, letterSpacing:1,fontSize:17}}>Run4Orphans</p>
                                    <p style={{fontSize:14}}>Run4Orphans is an organization that holds Races and allows
                                    ...
                                    <p style={{fontSize:14}}>
                                        ...
                                        <a style={{fontSize:12, color:'grey'}}>  Github</a>
                                    </p>
                                    <div className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="project-detail">
                                    ...
                                    <p style={{fontWeight:600, letterSpacing:1,fontSize:17}}>Mafia Game App</p>
                                    <p style={{fontSize:14}}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-10">
                                <ul style={{textAlign:'left'}}>
                                    <li className="other-projects-list" style={{fontSize: 14}}>
                                        <span className="other-span">EDIDreader Android Application: </span>
                                        Contracted to develop android application that connects via Bluetooth with
